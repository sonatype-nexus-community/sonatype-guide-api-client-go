...
// APIClient manages communication with the Sonatype Guide API API v202601
...
type APIClient struct {
	...
	CurrentUserOrganizationAPI *CurrentUserOrganizationAPIService

	CurrentUserTokensAPI *CurrentUserTokensAPIService

	OssiControllerAPI *OssiControllerAPIService
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	c.OssiControllerAPI = (*OssiControllerAPIService)(&c.common)
