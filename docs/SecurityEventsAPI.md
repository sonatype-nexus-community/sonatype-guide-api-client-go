...
func main() {
	...
	sortField := "sortField_example" // string | Field to sort by: ecosystem (FULL only), package, version (optional)
 ...
 **sortField** | **string** | Field to sort by: ecosystem (FULL only), package, version | 
