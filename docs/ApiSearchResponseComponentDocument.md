...
`func (o *ApiSearchResponseComponentDocument) GetActualTotal() int64`

GetActualTotal returns the ActualTotal field if non-nil, zero value otherwise.

### GetActualTotalOk

`func (o *ApiSearchResponseComponentDocument) GetActualTotalOk() (*int64, bool)`
...
`func (o *ApiSearchResponseComponentDocument) SetActualTotal(v int64)`

SetActualTotal sets ActualTotal field to given value.

### HasActualTotal

`func (o *ApiSearchResponseComponentDocument) HasActualTotal() bool`
