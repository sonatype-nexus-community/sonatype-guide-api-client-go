...
`func (o *ApiSearchResponseComponentDetailDocument) GetActualTotal() int64`

GetActualTotal returns the ActualTotal field if non-nil, zero value otherwise.

### GetActualTotalOk

`func (o *ApiSearchResponseComponentDetailDocument) GetActualTotalOk() (*int64, bool)`
...
`func (o *ApiSearchResponseComponentDetailDocument) SetActualTotal(v int64)`

SetActualTotal sets ActualTotal field to given value.

### HasActualTotal

`func (o *ApiSearchResponseComponentDetailDocument) HasActualTotal() bool`
