...
type CumulativeCreditUsage struct {
	...
	DailyAverage *int32 `json:"dailyAverage,omitempty"`
	DailyUsage []DailyCreditUsage `json:"dailyUsage,omitempty"`
	PeakDay *int32 `json:"peakDay,omitempty"`
	TotalCreditsUsed *int32 `json:"totalCreditsUsed,omitempty"`
}
...
// SetDailyAverage gets a reference to the given int32 and assigns it to the DailyAverage field.
...
// SetPeakDay gets a reference to the given int32 and assigns it to the PeakDay field.
...
// SetTotalCreditsUsed gets a reference to the given int32 and assigns it to the TotalCreditsUsed field.
